...
static void c4_c_emlrt_marshallIn(SFc4_mpclibInstanceStruct *chartInstance,
  const mxArray *c4_rseq, const char_T *c4_identifier, real_T c4_y[120]);
static void c4_d_emlrt_marshallIn(SFc4_mpclibInstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId, real_T c4_y[120]);
  ...
  *chartInstance)
{
  ...
  c4_rseq = (real_T (*)[120])ssGetOutputPortSignal(chartInstance->S, 1);
  c4_st = NULL;
  c4_st = NULL;
  c4_y = NULL;
  ...
  for (c4_i3 = 0; c4_i3 < 120; c4_i3++) {
    c4_b_u[c4_i3] = (*c4_rseq)[c4_i3];
  }

  c4_c_y = NULL;
  sf_mex_assign(&c4_c_y, sf_mex_create("y", c4_b_u, 0, 0U, 1U, 0U, 1, 120),
                FALSE);
...
static void sf_c4_mpclib(SFc4_mpclibInstanceStruct *chartInstance)
{
  ...
  c4_b_ref = (real_T (*)[6])ssGetInputPortSignal(chartInstance->S, 0);
  c4_c_vseq = (real_T (*)[21])ssGetOutputPortSignal(chartInstance->S, 2);
  c4_c_rseq = (real_T (*)[120])ssGetOutputPortSignal(chartInstance->S, 1);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 1U, chartInstance->c4_sfEvent);
  for (c4_i7 = 0; c4_i7 < 120; c4_i7++) {
  ...
  for (c4_i16 = 0; c4_i16 < 120; c4_i16++) {
  ...
  sf_debug_symbol_scope_add_eml_importable(&c4_nargout, 1U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(c4_ref, 2U, c4_f_sf_marshallOut);
  ...
  sf_debug_symbol_scope_add_eml_importable(&c4_b_p, 6U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c4_b_yoff, 7U, c4_e_sf_marshallOut,
    c4_e_sf_marshallIn);
  ...
  c4_f_y = NULL;
  sf_mex_assign(&c4_f_y, sf_mex_create("y", c4_f_u, 0, 0U, 1U, 0U, 1, 6), FALSE);
  c4_g_u = c4_b_voff;
  c4_g_y = NULL;
  ...
  for (c4_i20 = 0; c4_i20 < 120; c4_i20++) {
    c4_k_u[c4_i20] = c4_b_r_temp[c4_i20];
  }

  c4_k_y = NULL;
  sf_mex_assign(&c4_k_y, sf_mex_create("y", c4_k_u, 0, 0U, 1U, 0U, 1, 120),
                FALSE);
  c4_l_u = c4_b_md_temp;
  c4_l_y = NULL;
  ...
  for (c4_i21 = 0; c4_i21 < 120; c4_i21++) {
  ...
  for (c4_i23 = 0; c4_i23 < 120; c4_i23++) {
  ...
  *c4_inData)
{
  ...
  for (c4_i25 = 0; c4_i25 < 21; c4_i25++) {
    c4_b_inData[c4_i25] = (*(real_T (*)[21])c4_inData)[c4_i25];
  }

  for (c4_i26 = 0; c4_i26 < 21; c4_i26++) {
  ...
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData)
{
  ...
  for (c4_i27 = 0; c4_i27 < 21; c4_i27++) {
    (*(real_T (*)[21])c4_outData)[c4_i27] = c4_y[c4_i27];
  }
  ...
  *c4_inData)
{
  ...
  chartInstance = (SFc4_mpclibInstanceStruct *)chartInstanceVoid;
  c4_mxArrayOutData = NULL;
  for (c4_i28 = 0; c4_i28 < 120; c4_i28++) {
    c4_b_inData[c4_i28] = (*(real_T (*)[120])c4_inData)[c4_i28];
  }

  for (c4_i29 = 0; c4_i29 < 120; c4_i29++) {
  ...
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData)
{
  ...
  for (c4_i30 = 0; c4_i30 < 120; c4_i30++) {
    (*(real_T (*)[120])c4_outData)[c4_i30] = c4_y[c4_i30];
  }
  ...
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData)
{
  ...
  for (c4_i34 = 0; c4_i34 < 6; c4_i34++) {
    (*(real_T (*)[6])c4_outData)[c4_i34] = c4_y[c4_i34];
  }
  ...
  *c4_inData)
{
  ...
  for (c4_i35 = 0; c4_i35 < 6; c4_i35++) {
    c4_b_inData[c4_i35] = (*(real_T (*)[6])c4_inData)[c4_i35];
  }
  ...
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId, real_T c4_y[120])
{
  real_T c4_dv8[120];
  int32_T c4_i37;
  sf_mex_import(c4_parentId, sf_mex_dup(c4_u), c4_dv8, 1, 0, 0U, 1, 0U, 1, 120);
  for (c4_i37 = 0; c4_i37 < 120; c4_i37++) {
    c4_y[c4_i37] = c4_dv8[c4_i37];
  }
  ...
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId, real_T c4_y[21])
{
  real_T c4_dv9[21];
  int32_T c4_i38;
  sf_mex_import(c4_parentId, sf_mex_dup(c4_u), c4_dv9, 1, 0, 0U, 1, 0U, 1, 21);
  for (c4_i38 = 0; c4_i38 < 21; c4_i38++) {
    c4_y[c4_i38] = c4_dv9[c4_i38];
  }
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1565302235U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(971054257U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3528330058U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3479400413U);
}
...
mxArray *sf_c4_mpclib_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("Vq3hPjB1lbzZLgknMEkafC");
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          c4_ref = (real_T (*)[6])ssGetInputPortSignal(chartInstance->S, 0);
          c4_vseq = (real_T (*)[21])ssGetOutputPortSignal(chartInstance->S, 2);
          c4_rseq = (real_T (*)[120])ssGetOutputPortSignal(chartInstance->S, 1);
...
static void mdlSetWorkWidths_c4_mpclib(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1903132206U));
  ssSetChecksum1(S,(2664869170U));
  ssSetChecksum2(S,(1509690253U));
  ssSetChecksum3(S,(2641665897U));
